(function (global, factory) {
  ...
  var switchFetch = function (url, opts, timeout, worker) {
    return __awaiter(void 0, void 0, void 0, function () {
      var response, _a;
        ...
        switch (_b.label) {
          case 0:
            ...
            return [
              2 /*return*/,
              sendMessage(
                __assign({ url: url, timeout: timeout }, opts),
                worker
              )
            ];
          case 1:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              fetchWithTimeout(url, options, worker, timeout)
            ];
          case 3:
            response = _b.sent();
            fetchError = null;
  ...
  var oauthToken = function (_a, worker) {
    return __awaiter(void 0, void 0, void 0, function () {
      var baseUrl = _a.baseUrl,
        timeout = _a.timeout,
        options = __rest(_a, ['baseUrl', 'timeout']);
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
          ...
          switch (_a.label) {
            ...
            case 2:
              ...
              return [
                4 /*yield*/,
                oauthToken(
                  __assign(__assign({}, customOptions), {
                    baseUrl: this.domainUrl,
                    client_id: this.options.client_id,
                    code_verifier: code_verifier,
                    code: codeResult.code,
