!(function (e, t) {
  ...
  var ie,
    ...
    xe = function (e, t) {
      for (var n = Oe(t), r = R.f, o = W.f, i = 0; i < n.length; i++) {
        var a = n[i];
        O(e, a) || r(e, a, o(t, a));
      }
    },
    ...
    Ee = function (e, t) {
      var n = Le[Ae(e)];
      return n == Ce || (n != We && ('function' == typeof t ? f(t) : !!t));
    },
    ...
    Ke = function (e, t) {
      ...
      if ((n = s ? l : u ? l[c] || U(c, {}) : (l[c] || {}).prototype))
        for (r in t) {
          if (
            ((i = t[r]),
            (o = e.noTargetGet ? (a = Re(n, r)) && a.value : n[r]),
            !Ze(s ? r : c + (u ? '.' : '#') + r, e.forced) && void 0 !== o)
          ) {
      ...
      if (
        (m &&
          ...
          Lt !== Object.prototype &&
            c.next &&
            (ft(c) !== Lt &&
              (At ? At(c, Lt) : 'function' != typeof c[Ct] && K(c, Ct, Zt)),
            Ot(c, f, !0))),
        'values' == o &&
          h &&
          'values' !== h.name &&
        ...
        if (
          ...
          for (u in s) (Wt || d || !(u in p)) && ce(p, u, s[u]);
        else Ke({ target: t, proto: !0, forced: Wt || d }, s);
      return s;
    },
    Kt = at.charAt,
    Ut = ae.set,
    ...
    Zn = (function (e, t) {
      ...
      return (Ln[e] =
        ...
        !f(function () {
          if (r && !d) return !0;
          var e = { length: -1 };
          r ? An(e, 1, { enumerable: !0, get: Wn }) : (e[1] = 1),
            n.call(e, o, i);
        }));
    ...
    Kn = s(function (e) {
      var t = R.f,
        ...
        a = (e.exports = {
          ...
          onFreeze: function (e) {
            return Rn && a.REQUIRED && o(e) && !O(e, n) && i(e), e;
          }
        });
      Q[n] = !0;
    }),
  ...
  var mr = { timeoutInSeconds: 60 },
    ...
    Sr = function () {
      var e =
        ...
        t = '';
      return (
        Array.from(Lr().getRandomValues(new Uint8Array(43))).forEach(function (
          n
        ) {
                  ...
                  case 1:
                    return (
                      ...
                      c.access_token
                        ...
                        : [
                            4,
                            io.acquireLock('auth0.lock.getTokenSilently', 5e3)
                          ]
                    );
                  case 2:
                    return (
  ...
  var lo = uo;
  return (lo.Auth0Client = so), (lo.createAuth0Client = uo), lo;
}),
  'Auth0Client' in this &&
    this.console &&
    this.console.warn &&
